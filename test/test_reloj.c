...
/*3) Configurar la biblioteca, ajustar la hora (con valores incorrectos) tiene que devolver un error y al consultar la hora tiene que ser invalida.
...
14) Si la alarma se activo, y la pospongo n minutos, vuelve a sonar n minutos
15) Si la alarma se activo, y la cancelo, al día siguiente, vuelve a sonar
...
//9) Configurar la hora de la alarma (con valores correctos) y revisar si la alarma queda activada.
...
//Si la activo, y la pospongo n minutos, vuelve a sonar n minutos
